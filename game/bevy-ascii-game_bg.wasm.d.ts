...
export function closure6786_externref_shim(a: number, b: number, c: number): void;
...
export function closure6789_externref_shim(a: number, b: number, c: number, d: number): void;
export function closure46208_externref_shim(a: number, b: number, c: number): void;
