...
export function wasm_bindgen__convert__closures__invoke1_mut__h391fecd6fcd7f510(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h8302b548c473028e(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hed7ffa1f1f397723(a: number, b: number, c: number): void;
