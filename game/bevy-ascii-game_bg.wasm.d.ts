...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h02ee24fd44c6a653(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0ffe98d95f31b710(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h3902943f89d71e72(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__hef6a02829d89d8cd(a: number, b: number, c: number): void;
