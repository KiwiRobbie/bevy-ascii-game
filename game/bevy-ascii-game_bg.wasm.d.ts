...
export function closure6794_externref_shim(a: number, b: number, c: number): void;
...
export function closure6797_externref_shim(a: number, b: number, c: number, d: number): void;
export function closure54368_externref_shim(a: number, b: number, c: number): void;
