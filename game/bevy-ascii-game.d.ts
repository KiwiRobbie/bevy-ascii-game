...
export interface InitOutput {
  ...
  readonly closure6794_externref_shim: (a: number, b: number, c: number) => void;
  ...
  readonly closure6797_externref_shim: (a: number, b: number, c: number, d: number) => void;
  readonly closure54368_externref_shim: (a: number, b: number, c: number) => void;
