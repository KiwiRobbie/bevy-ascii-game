...
export interface InitOutput {
  ...
  readonly closure6786_externref_shim: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2aa981cb1ae9d9db: (a: number, b: number) => void;
  readonly closure6789_externref_shim: (a: number, b: number, c: number, d: number) => void;
  readonly closure46208_externref_shim: (a: number, b: number, c: number) => void;
