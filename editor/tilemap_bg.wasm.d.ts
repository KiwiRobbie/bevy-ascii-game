...
export function closure6524_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h68c9e733f8bcd713(a: number, b: number): void;
export function closure6527_externref_shim(a: number, b: number, c: number, d: number): void;
export function closure54112_externref_shim(a: number, b: number, c: number): void;
