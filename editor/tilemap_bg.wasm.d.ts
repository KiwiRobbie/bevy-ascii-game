...
export function closure6516_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2aa981cb1ae9d9db(a: number, b: number): void;
export function closure6519_externref_shim(a: number, b: number, c: number, d: number): void;
export function closure45952_externref_shim(a: number, b: number, c: number): void;
