...
export interface InitOutput {
  ...
  readonly closure6516_externref_shim: (a: number, b: number, c: number) => void;
  ...
  readonly closure6519_externref_shim: (a: number, b: number, c: number, d: number) => void;
  readonly closure45952_externref_shim: (a: number, b: number, c: number) => void;
